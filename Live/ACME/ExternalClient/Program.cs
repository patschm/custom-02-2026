...
{
    private static string ServiceUrl = "https://localhost:7082/";
    ...
    private static async Task DoTheCodeFlowAsync()
    {
        ...
        var bld = PublicClientApplicationBuilder
            .Create("a1fec23e-3d27-4b09-b6f1-64f2662f978e")
            .WithAuthority(AzureCloudInstance.AzurePublic, "420d8d99-43b5-46a6-a6d5-2cfc459bc193")
            .WithRedirectUri("http://localhost:9898/");  // http scheme only!

        var app = bld.Build();
        // .AcquireTokenByUsernamePassword
        var token = await app.AcquireTokenInteractive(
            new string[] { "api://91a4ca35-7a0a-4885-9b2c-d5bb6121a2bf/Weer" })
            .ExecuteAsync();
